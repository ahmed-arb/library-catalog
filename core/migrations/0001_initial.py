    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(help_text="Name of the book.", max_length=255),
                ),
                (
                    "authors",
                    models.ManyToManyField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "date_due",
                    models.DateField(help_text="Date Field for when the book is due. Format: <em>YYYY-MM-DD</em>."),
                ),
                (
                    "date_returned",
                    models.DateField(
                ...
                (
                    "book",
                    models.ForeignKey(
                        help_text="Reference field for book.",
